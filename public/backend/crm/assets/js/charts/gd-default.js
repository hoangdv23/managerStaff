...
!function (NioApp, $) {
  ...
  var salesRevenue = {
    ...
    stacked: true,
    datasets: [{
      label: "Danh sách tháng trong năm",
      color: [NioApp.hexRGB("#6576ff", .2), NioApp.hexRGB("#6576ff", .2), NioApp.hexRGB("#6576ff", .2), NioApp.hexRGB("#6576ff", .2), NioApp.hexRGB("#6576ff", .2), NioApp.hexRGB("#6576ff", .2), NioApp.hexRGB("#6576ff", .2), NioApp.hexRGB("#6576ff", .2), NioApp.hexRGB("#6576ff", .2), NioApp.hexRGB("#6576ff", .2), NioApp.hexRGB("#6576ff", .2), NioApp.hexRGB("#6576ff", .2)],
      data: configReport.totalCallOfListMonthYear
    }]
  };
  var activeSubscription = {
    labels: configReport.getListMonthOfTwoDay,
    dataUnit: 'giây gọi',
    stacked: true,
    datasets: [{
      label: "Active User",
      ...
      data: configReport.listCallMinuteCallInMonth
    }]
  };
  var totalSubscription = {
    ...
    datasets: [{
      ...
      data: configReport.listCallMinuteCallSuccessInMonth
    }]
  };
  ...
  var salesOverview = {
    labels: configReport.getListDayOfCurrentMonth,
    dataUnit: 'Cuộc gọi',
    lineTension: .3,
    datasets: [{
      label: "Cuộc gọi",
      color: "#1676fb",
      background: NioApp.hexRGB('#1676fb', .8),
      data: configReport.totalCall
    },{
      label: "Thành công",
      color: "#1ee0ac",
      background: NioApp.hexRGB('#1ee0ac', .8),
      data: configReport.totalCallSuccess
    },{
      label: "Thất bại",
      color: "#db4924",
      background: NioApp.hexRGB('#db4924', .8),
      data: configReport.totalCallFalse
    }]
  };
