...
function startWatch() {
    ...
    var x = document.getElementById("call_timer");
    x.innerHTML = gethours + mins + secs;
    /* display the Count-Up Timer dashboard */
    var xdashboard = document.getElementById("call_timer_dashboard");
    xdashboard.innerHTML = gethours + mins + secs;
    /* display the Count-Up Timer Modal */
    var xModal = document.getElementById("call_timer_dashboard_modal");
    xModal.innerHTML = gethours + mins + secs;
...
function pauseTime() {
    if (seconds !== 0 || minutes !== 0 || hours !== 0) {
        ...
        /* display the Count-Up Timer dashboard */
        var xdashboard = document.getElementById("call_timer_dashboard");
        var stopTimeDashboard = gethours + mins + secs;
        xdashboard.innerHTML = stopTimeDashboard;
        /* display the Count-Up Timer Modal */
        var xdashboardModal = document.getElementById("call_timer_dashboard_modal");
        var stopTimeDashboardModal = gethours + mins + secs;
        xdashboardModal.innerHTML = stopTimeDashboardModal;
        /* display all Count-Up control buttons */
        /*var showStop = document.getElementById("stop");
        showStop.style.display = "inline-block";*/
        /* clear the Count-Up using the setTimeout( ) 
